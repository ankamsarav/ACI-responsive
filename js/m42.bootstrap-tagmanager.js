...
(function($){
  ...
  $.fn.tagsManager = function (options,tagToManipulate) {
    ...
    var refreshHiddenTagList = function (triggerRefresh) {
      var tlis = obj.data("tlis");
      var lhiddenTagList = obj.data("lhiddenTagList");

      console.log('triggerrefresh',triggerRefresh);
      if(typeof triggerRefresh == 'undefined') triggerRefresh = true;
      if(triggerRefresh) obj.trigger('tags:refresh', tlis.join(baseDelimiter));
    ...
    var pushTag = function (tag,ajaxPushFlag) {
      tag = trimTag(tag);
      ...
      if (alreadyInList) {
        ...
        console.log('ajaxpushflag',ajaxPushFlag);
        if(typeof ajaxPushFlag != 'undefined' && ajaxPushFlag){
            if (tagManagerOptions.AjaxPush != null) {
              if(tagManagerOptions.AjaxPushAllTags == null)
        ...
        refreshHiddenTagList(ajaxPushFlag);
    ...
    var prefill = function (pta,ajaxPushFlag) {
      $.each(pta, function (key, val) {
        pushTag(val,ajaxPushFlag);
      });
    };
    ...
    return this.each(function () {
      ...
      if (tagManagerOptions.prefilled != null) {
        if (typeof (tagManagerOptions.prefilled) == "object") {
          prefill(tagManagerOptions.prefilled,false);
        } else if (typeof (tagManagerOptions.prefilled) == "string") {
          prefill(tagManagerOptions.prefilled.split(baseDelimiter),false);
        } else if (typeof (tagManagerOptions.prefilled) == "function") {
          prefill(tagManagerOptions.prefilled(),false);
        }
      } else if (tagManagerOptions.hiddenTagListId != null) {
        prefill($('#' + tagManagerOptions.hiddenTagListId).val().split(baseDelimiter),false);
      }

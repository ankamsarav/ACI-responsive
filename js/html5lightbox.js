	...
	(function ($) {
		$.fn.html5lightbox = function (options) {
			...
			inst.createMarkup = function () {
				...
				var elemText = "<div id='html5-elem-data-box' style='display:none;height:20%'><div id='html5-text' style='display:block;overflow:hidden;'></div></div>";
				...
				if (inst.options.closepos == "topright")
					...
					inst.$elemData.append("<div id='html5-close' style='display:block;cursor:pointer;float:right;margin-right:" + inst.options.bordersize + "px;'><img src='" + inst.options.skinsfolder + inst.options.closeimage + "'></div>");
			...
			inst.showData = function () {
				...
				if (inst.options.closepos == "bottom" ||
					inst.$text.text().length > 0 && inst.options.titlepos != "over")
					inst.$lightboxBox.css({
			...
			inst.embedFlash = function ($container, w, h, src, wmode, flashVars) {
				if (inst.options.flashInstalled) {
					...
					$container.html("<div class='html5lightbox-flash-error' style='display:block; position:relative;text-align:center; width:" + w + "px; left:0px; top:" +
